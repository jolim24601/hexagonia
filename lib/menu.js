...
Hexscape.Menu.prototype = {
  preload: function () {
    ...
    var github = this.add.button(width - 75, height - 60, 'github', function () {
      window.location.href = "https://github.com/jolim24601"
    });
    var linkedin = this.add.button(width - 130, height - 60, 'linkedin', function () {
      window.location.href = "https://www.linkedin.com/in/john-lim-86500358"
    });
    var portfolio = this.add.button(width - 185, height - 65, 'portfolio', function () {
