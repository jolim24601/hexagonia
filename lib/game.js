...
Hexscape.Game.prototype = {
  ...
  update: function () {
    if (ball.x > (this.portalGroup.x + Hexscape.BALL_RADIUS)
        && ball.x < (this.portalGroup.x + this.portalGroup.width - Hexscape.BALL_RADIUS)
        && ball.y > this.portalGroup.y
        && ball.inWorld
        && !this.roundWon) {
  ...
  createBall: function (pos) {
    ...
    ball.body.setCircle(Hexscape.BALL_RADIUS);
    ball.body.setCollisionGroup(this.ballCollisionGroup);
    ball.body.collides(this.hexCollisionGroup);
    ball.body.collides(this.bouncyCollisionGroup, this.addBounce, this);
  },
  pauseGame: function () {
